...
class MainTest {
    ...
    @Test
    public void UnosSelektovana2Stavke(FxRobot robot) {
        robot.clickOn("#tab_racun");
        ...
        robot.clickOn("#racun");
        robot.clickOn("#choice");
        robot.clickOn("MLK001,Mlijeko Meggle,1.1");
        robot.clickOn("#spinner").clickOn(".increment-arrow-button");
        robot.clickOn("#spinner").clickOn(".increment-arrow-button");
        robot.clickOn("#spinner").clickOn(".increment-arrow-button");
        robot.clickOn("#spinner").clickOn(".decrement-arrow-button");
        robot.clickOn("#racun");
        TextArea textArea = (TextArea)robot.lookup("#racun_izlaz").query();
        assertEquals("HLB002,Bijeli hljeb,1.2 3\n" + "MLK001,Mlijeko Meggle,1.1 5\n", textArea.getText());
    }
